WITH consommation_par_quart_temperature AS (
    SELECT
    ...
    GROUP BY quart, temperature_intervalle
)
SELECT * FROM consommation_par_quart_temperature
